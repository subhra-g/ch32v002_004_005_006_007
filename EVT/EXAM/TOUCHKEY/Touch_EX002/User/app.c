...
static volatile uint16_t print_time = 0;
...
void        TKY_dataProcess( void )
{
    ...
    case KEY_1_LONG :
        ...
        break;
    case KEY_1_UP :
        TKY_KeyBacklightOut( 1, DISABLE );
        PRINT( "KEY_2_LONG !\n" );
        break;
    case KEY_2_DOWN :
        TKY_KeyBacklightOut( 2, ENABLE );
        PRINT( "KEY_3_DOWN !\n" );
        break;
    case KEY_2_LONG :
        TKY_KeyBacklightOut( 2, ENABLE );
        ...
        break;
    case KEY_2_UP :
        TKY_KeyBacklightOut( 2, DISABLE );
        PRINT( "KEY_3_LONG !\n" );
        break;
    case KEY_3_DOWN :
        TKY_KeyBacklightOut( 3, ENABLE );
        PRINT( "KEY_4_DOWN !\n" );
        break;
    case KEY_3_LONG :
        TKY_KeyBacklightOut( 3, ENABLE );
        ...
        break;
    case KEY_3_UP :
        TKY_KeyBacklightOut( 3, DISABLE );
        PRINT( "KEY_4_LONG !\n" );
        break;
    case KEY_4_DOWN :
        TKY_KeyBacklightOut( 4, ENABLE );
        PRINT( "KEY_5_DOWN !\n" );
        break;
    case KEY_4_LONG :
        TKY_KeyBacklightOut( 4, ENABLE );
        ...
        break;
    case KEY_4_UP :
        TKY_KeyBacklightOut( 4, DISABLE );
        PRINT( "KEY_5_LONG !\n" );
        break;
    case KEY_5_DOWN :
        TKY_KeyBacklightOut( 5, ENABLE );
        PRINT( "KEY_6_DOWN !\n" );
        break;
    case KEY_5_LONG :
        TKY_KeyBacklightOut( 5, ENABLE );
        ...
        break;
    case KEY_5_UP :
        TKY_KeyBacklightOut( 5, DISABLE );
        PRINT( "KEY_6_LONG !\n" );
        break;
    case KEY_6_DOWN :
        TKY_KeyBacklightOut( 6, ENABLE );
        PRINT( "KEY_7_DOWN !\n" );
        break;
    case KEY_6_LONG :
        TKY_KeyBacklightOut( 6, ENABLE );
